...
var urlFromConfig = function(collConfig, srvConfig) {
	var url = 'mongodb://';
	url += collConfig.db.servers.favorloca.host + ':' + collConfig.db.servers.favorloca.port + '/' + collConfig.db.collections.users.database;
	return url;
};
...
var connectInfoFromConfig = function(collectionName, defaultConfig) {
	...
	var dbCfg = collCfg ? cfg.db.databases.favorloca.server : null;
